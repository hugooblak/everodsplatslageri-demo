...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'everodsplatslageri-leads' ),
				'storm'       => __( 'Storm or hail damage', 'everodsplatslageri-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'everodsplatslageri-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'everodsplatslageri-leads' ),
				'not-sure'    => __( 'Vet inte än', 'everodsplatslageri-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'everodsplatslageri-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'everodsplatslageri-leads' ),
				'research' => __( 'Jag kollar bara priser', 'everodsplatslageri-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'everodsplatslageri-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'everodsplatslageri-leads' ),
		'contacted' => __( 'Kontaktad', 'everodsplatslageri-leads' ),
		'quoted'    => __( 'Quote sent', 'everodsplatslageri-leads' ),
		'won'       => __( 'Won', 'everodsplatslageri-leads' ),
		'lost'      => __( 'Lost', 'everodsplatslageri-leads' ),
		'spam'      => __( 'Misstänkt spam', 'everodsplatslageri-leads' ),
	);
}
