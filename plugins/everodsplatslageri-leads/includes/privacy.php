...
add_filter(
	...
	function ( $exporters ) {
		$exporters['everodsplatslageri-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'everodsplatslageri-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'everodsplatslageri-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'everodsplatslageri-leads',
						'group_label' => __( 'Quote requests', 'everodsplatslageri-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['everodsplatslageri-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'everodsplatslageri-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {
