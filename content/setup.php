<?php
/**
 * Demo site setup for Everöds Plåtslageri AB.
 *
 ...
 *
 * @package Everöds Plåtslageri AB
 */
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Everöds Plåtslageri AB' );
...
$home = nps_page(
	...
	nps_pattern( 'everodsplatslageri/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'everodsplatslageri/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'everodsplatslageri/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'everodsplatslageri/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'everodsplatslageri/thank-you' ),
...
<p class="has-large-font-size">Everöds Plåtslageri AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Everöds Plåtslageri AB', $about_content . "\n\n" . nps_pattern( 'everodsplatslageri/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'everodsplatslageri/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Everöds Plåtslageri AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Everöds Plåtslageri AB demo ready.' );
