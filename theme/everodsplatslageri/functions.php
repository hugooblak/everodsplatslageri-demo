<?php
/**
 * Everöds Plåtslageri AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Everöds Plåtslageri AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through ev_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'everodsplatslageri', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'everodsplatslageri' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'everodsplatslageri' ) ) );

		register_block_pattern_category( 'everodsplatslageri-sections', array( 'label' => __( 'Everöds Plåtslageri AB sections', 'everodsplatslageri' ) ) );
		register_block_pattern_category( 'everodsplatslageri-pages', array( 'label' => __( 'Everöds Plåtslageri AB page layouts', 'everodsplatslageri' ) ) );
	}
);
